...
use App\GraphQL\Types\{QuestType, CategoryType};
use App\GraphQL\Queries\{QuestQuery, QuestsQuery, CategoryQuery, CategoriesQuery};
use App\GraphQL\Mutations\{UpdateQuestMutation,
    DeleteQuestMutation,
    CreateQuestMutation,
